...
$post['A1']=iconv('UTF-8','cp1251',$_REQUEST['A1']);
$post['A2']=iconv('UTF-8','cp1251',$_REQUEST['A2']);
$post['A3']=iconv('UTF-8','cp1251',$_REQUEST['A3']);
$post['A4']=iconv('UTF-8','cp1251',$_REQUEST['A4']);
?>
